...
public class WebService1Locator extends org.apache.axis.client.Service implements se.lu.ics.WebService1 {
    ...
    private java.lang.String WebService1Soap_address = "http://localhost/WebServiceClient1/WebService1.asmx";
    ...
    public se.lu.ics.WebService1Soap getWebService1Soap() throws javax.xml.rpc.ServiceException {
    ...
    public se.lu.ics.WebService1Soap getWebService1Soap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            se.lu.ics.WebService1SoapStub _stub = new se.lu.ics.WebService1SoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (se.lu.ics.WebService1Soap.class.isAssignableFrom(serviceEndpointInterface)) {
                se.lu.ics.WebService1SoapStub _stub = new se.lu.ics.WebService1SoapStub(new java.net.URL(WebService1Soap_address), this);
                _stub.setPortName(getWebService1SoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ics.lu.se/", "WebService1");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ics.lu.se/", "WebService1Soap"));
        }
